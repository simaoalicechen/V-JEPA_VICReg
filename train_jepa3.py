...
def forward_pass(epoch, batch_num, encoder, predictor, frames, actions = None):
    ...
    # of 0.005
    bact_loss_dict['total_weighted_loss'] = bact_loss_dict["total_pred_loss"]*0.001 + \
                        bact_loss_dict["total_var_loss"]*0.1 + bact_loss_dict["total_cov_loss"]*1
     
    # return predictions and corresponding targets 
    return bact_loss_dict
...
optim = Adam(list(encoder.parameters())+ list(predictor.parameters()), lr=0.0025)
